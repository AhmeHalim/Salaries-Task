...
| -------------------------------------------------------------------*/
	...
	$config['img_path'] = '/uploads/itemtopic'; // Relative to domain name
	$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] . $config['img_path']; // Physical path. [Usually works fine like this]
	//$config['upload_path'] = 'http://localhost/medical/uploads/itemtopic/'; // Physical path. [Usually works fine like this]
